"""
scp ubuntu@${EC2}:/home/ubuntu/src/vgg_checkpoint.pth ./vision/cnns/trained

scp ubuntu@${EC2}:/home/ubuntu/src/vgg_model.pth ./vision/cnns/trained

scp ubuntu@${EC2}:/home/ubuntu/src/vgg_training_curves.png .

scp ubuntu@${EC2}:/home/ubuntu/src/vgg_cm.png .
"""
import torch
...
if '__name__' == '__name__':
    ...
    cm_img = 'vgg_cm.png'
    model_weights = 'vgg_model.pth'
    model_checkpoint = 'vgg_checkpoint.pth'
    curves_img = 'vgg_training_curves.png'
