...
class DeeperCNN(nn.Module):
    def __init__(self):
        ...
        self.classifier = nn.Sequential(
            nn.Flatten(),
            nn.Linear(128 * 2 * 2, 256),  # 128 channels of 2x2 feature maps -> 256 features.
            nn.ReLU(),
